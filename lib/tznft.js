...
commander_1.program
    ...
    return contracts.showBalances(options.operator, options.nft, options.owner, options.tokens);
...
commander_1.program
    ...
    .requiredOption('-t, --tokens <tokens...>', 'list of token IDs to check')
    .action((options) => __awaiter(void 0, void 0, void 0, function* () {
    return contracts.showMetadata(options.operator, options.nft, options.tokens);
})).passCommandToAction(false);
//prettier-ignore
commander_1.program
    .command('transfer')
    ...
    .action((options) => __awaiter(void 0, void 0, void 0, function* () {
    return contracts.transfer(options.operator, options.nft, options.batch);
})).passCommandToAction(false);
//prettier-ignore
commander_1.program
    .command('update-ops')
