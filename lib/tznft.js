...
commander_1.program
    ...
    .arguments('<owner>')
    .requiredOption('-n, --nft <nft_address>', 'address of the NFT contract')
    .option('-a, --add [add_operators...]', 'list of the operators and token ID pairs to be added by the token owner')
    .option('-r, --remove [remove_operators...]', 'list of the operators and token ID pairs to be removed by the token owner')
