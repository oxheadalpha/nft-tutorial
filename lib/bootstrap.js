...
function startSandbox() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = (0, config_util_1.loadUserConfig)();
        const toolkit = yield (0, contracts_1.createToolkit)('bob', config);
...
function originateBalanceInspector(config, orig_alias) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tezos = yield (0, contracts_1.createToolkit)(orig_alias, config);
        const inspectorAddress = yield (0, contracts_1.originateInspector)(tezos);
        config.set((0, config_util_1.inspectorKey)(config), inspectorAddress);
