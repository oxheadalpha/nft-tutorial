...
exports.suggestCommand = exports.loadFile = exports.inspectorKey = exports.aliasKey = exports.allAliasesKey = exports.activeNetworkKey = exports.loadUserConfig = exports.initUserConfig = exports.userConfigFileWithExt = void 0;
...
function initUserConfig() {
    if (fs.existsSync(exports.userConfigFileWithExt)) {
        ...
        console.log(`${kleur.green(path.join(process.cwd(), 'tznft.json'))} config file created`);
    }
}
...
const allAliasesKey = (config) => `${activeNetworkKey(config)}.aliases`;
exports.allAliasesKey = allAliasesKey;
const aliasKey = (alias, config) => `${(0, exports.allAliasesKey)(config)}.${alias}`;
exports.aliasKey = aliasKey;
const inspectorKey = (config) => `${activeNetworkKey(config)}.inspector`;
