...
function createToolkit(address_or_alias, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const signer = yield (0, config_aliases_1.resolveAlias2Signer)(address_or_alias, config);
...
function createToolkitFromSigner(signer, config) {
    const pk = `${(0, config_util_1.activeNetworkKey)(config)}.providerUrl`;
...
function originateInspector(tezos) {
    return __awaiter(this, void 0, void 0, function* () {
        const code = yield (0, config_util_1.loadFile)(path.join(__dirname, '../ligo/out/inspector.tz'));
...
function mintNfts(owner, tokens) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = (0, config_util_1.loadUserConfig)();
        const tz = yield createToolkit(owner, config);
        const ownerAddress = yield tz.signer.publicKeyHash();
        const code = yield (0, config_util_1.loadFile)(path.join(__dirname, '../ligo/out/fa2_fixed_collection_token.tz'));
...
function showBalances(signer, nft, owner, tokens) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ownerAddress = yield (0, config_aliases_1.resolveAlias2Address)(owner, config);
        const nftAddress = yield (0, config_aliases_1.resolveAlias2Address)(nft, config);
        const requests = tokens.map(t => {
            return { token_id: new bignumber_js_1.BigNumber(t), owner: ownerAddress };
        });
        const inspectorAddress = config.get((0, config_util_1.inspectorKey)(config));
        if (!inspectorAddress || typeof inspectorAddress !== 'string') {
            console.log(kleur.red('Cannot find deployed balance inspector contract.'));
            (0, config_util_1.suggestCommand)('bootstrap');
            return;
        }
...
function resolveTxAddresses(transfers, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const resolved = transfers.map((t) => __awaiter(this, void 0, void 0, function* () {
            return {
                from_: yield (0, config_aliases_1.resolveAlias2Address)(t.from_, config),
...
function resolveTxDestinationAddresses(txs, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const resolved = txs.map((t) => __awaiter(this, void 0, void 0, function* () {
            return {
                to_: yield (0, config_aliases_1.resolveAlias2Address)(t.to_, config),
                amount: t.amount,
                token_id: t.token_id
            };
        }));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const resolved = operators.map((o) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const operator = yield (0, config_aliases_1.resolveAlias2Address)(op, config);
