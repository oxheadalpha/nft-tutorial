...
function printAllAliases(config) {
    const allAliasesCfg = config.get((0, config_util_1.allAliasesKey)(config));
    if (allAliasesCfg) {
...
function printAlias(alias, config) {
    const aliasDef = config.get((0, config_util_1.aliasKey)(alias, config));
    if (aliasDef)
...
function addAlias(alias, key_or_address) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = (0, config_util_1.loadUserConfig)();
        const ak = (0, config_util_1.aliasKey)(alias, config);
        if (config.has(ak)) {
...
function addAliasFromFaucet(alias, faucetFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const faucetContent = yield (0, config_util_1.loadFile)(filePath);
        ...
        yield activateFaucet(signer, faucet.activation_code);
...
function activateFaucet(signer, secret) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = (0, config_util_1.loadUserConfig)();
        const tz = (0, contracts_1.createToolkitFromSigner)(signer, config);
...
function validateKey(key_or_address) {
    return __awaiter(this, void 0, void 0, function* () {
        if ((0, utils_1.validateAddress)(key_or_address) === utils_1.ValidationResult.VALID)
...
function resolveAlias2Signer(alias_or_address, config) {
    return __awaiter(this, void 0, void 0, function* () {
        const aliasDef = config.get((0, config_util_1.aliasKey)(alias_or_address, config));
        ...
        if ((0, utils_1.validateAddress)(alias_or_address) !== utils_1.ValidationResult.VALID)
...
function findAlias(config, predicate) {
    const allAliases = Object.getOwnPropertyNames(config.get((0, config_util_1.allAliasesKey)(config)));
    for (let a of allAliases) {
        const aliasDef = config.get((0, config_util_1.aliasKey)(a, config));
...
function resolveAlias2Address(alias_or_address, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ak = (0, config_util_1.aliasKey)(alias_or_address, config);
        if (!config.has(ak))
            return cannotResolve(alias_or_address);
